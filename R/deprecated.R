...
deprecated.steppingstoneMCMC <- function(tree,dat,powerPosterior,k,Bk,SE=NA,model="OU",ngen=100000,samp=20,chunk=200,control=NULL,tuning=NULL,new.dir=FALSE,plot=TRUE,plot.freq=500,outname="bayou.ss",ticker.freq=1000,tuning.int=c(0.1,0.2,0.3),startpar=NULL,moves=NULL,control.weights=NULL){
  if(is.null(moves)){
